...
oriPath = "/home/chicho/workspace/repackaged/ResDroid/Ori_coaseVec.csv"

repPath = "/home/chicho/workspace/repackaged/ResDroid/Rep_coaseVec.csv"
...
for line in lines:
    ...
    cmd = "echo {0},{1},{2},{3}>>{4}".format(oriapk,repapk,sim,elapse,"Corase_similarScore")
    os.system(cmd)
