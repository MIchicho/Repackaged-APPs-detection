...
# description : this file is used to create the ATG activity transition graph
...
if (input == '0'):
    ...
    outputPath = "/home/chicho/workspace/repackaged/MassVet/graph/originalANALYSIS.txt"
...
if (input == '1'):
    ...
    outputPath = "/home/chicho/workspace/repackaged/MassVet/graph/repackagedANALySIS.txt"
...
def getTheEdgeSet(manifestPath,apkSatgPath,apkname):
    ...
    cmd = '''echo "actCnt: " {0} >>{1}'''.format(actCnt,outputPath)
    os.system(cmd)
...
#                        print tmpParentNameList
        ...
        elapse = str(end-start)

        cmd =  "echo {0},{1} >> {2}".format(apkname,elapse,"createGraphTimeRep.csv")
        os.system(cmd)
