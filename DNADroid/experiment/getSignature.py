...
oriPath = "/home/chicho/workspace/repackaged/DNADroid/experiment/falsepositive/result/"

orioutPutPath = "/home/chicho/workspace/repackaged/DNADroid/experiment/falsepositive/sig/"


if not os.path.exists(orioutPutPath):
    os.makedirs(orioutPutPath)
